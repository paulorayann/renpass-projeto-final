...
module.exports = (server, routes, prefix = '/api/v1/rental') => {
  ...
  routes.get('/:rentalId/fleet', validateFleetGet, FleetController.list);
  routes.get('/:rentalId/fleet/:id', validateFleetGet, FleetController.getById);
  routes.patch('/:rentalId/fleet/:id', validateFleetUpdate, FleetController.update);
